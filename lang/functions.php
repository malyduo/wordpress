...
if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
        'name' => __('Kontakt', 'html5blank'),
        'description' => __('Kontakt na stronie głównej...', 'html5blank'),
        'id' => 'kontakt',
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h2>',
    ...
    // Define Sidebar
    register_sidebar(array(
        'name' => __('Formularz kontaktowy', 'html5blank'),
        'description' => __('Formularz na stronie głównej...', 'html5blank'),
        'id' => 'kontakt-form',
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h2>',
    ...
    // Define Sidebar
    register_sidebar(array(
        'name' => __('Oferta', 'html5blank'),
        'description' => __('Oferta sekcja', 'html5blank'),
        'id' => 'jezyki_oferta',
        'before_widget' => '',
        'after_widget' => '',
