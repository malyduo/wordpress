...
if (function_exists('register_sidebar'))
{
     ...
     // Define Sidebar Stopka
    register_sidebar(array(
        'name' => __('Opinie', 'html5blank'),
        'description' => __('Opinie na stronie głównej...', 'html5blank'),
        'id' => 'opinie',
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '',
...
function uslugi_cena(){
    if ( $keys = get_post_custom_keys() ) {
		foreach ( (array) $keys as $key ) {
			...
			$html = sprintf( "<span class='post-meta-key'>%s</span> %s\n",
